...
const Something = () => {
  return (
    <div className="h-[400px] p-6 md:px-16">
      ...
      >
        <SwiperSlide>
          <div className="p-6 text-white border-2 border-purple-500 ">
            ...
            <p className="mt-2">
              I develop website.I create high performance website with blazing
              fast speed.
            </p>
          </div>
        </SwiperSlide>
        ...
        <SwiperSlide>
          <div className="p-6 text-white border-2 border-purple-500 ">
            ...
            <p className="text-center font-bold text-2xl">brand identity</p>
            <p className="mt-2">
              I develop website.I create high performance website with blazing
              fast speed.
            </p>
      ...
      <h2>New thing added in this project</h2>
    </div>
  );
};
